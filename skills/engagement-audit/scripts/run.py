#!/usr/bin/env python3
"""CLI wrapper for the engagement-audit specialist skill."""
...
if __name__ == "__main__":
    ...
    try:
        ...
        findings = run_engagement_audit(evidence=evidence, website=website)
        print(json.dumps(
            {"ok": True, "skill": "engagement-audit", "findings": [f.model_dump() for f in findings]},
