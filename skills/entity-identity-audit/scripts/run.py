#!/usr/bin/env python3
"""CLI wrapper for the entity-identity-audit specialist skill."""
...
if __name__ == "__main__":
    ...
    try:
        ...
        findings = run_entity_identity_audit(evidence=evidence, website=website)
        print(json.dumps(
            {"ok": True, "skill": "entity-identity-audit", "findings": [f.model_dump() for f in findings]},
