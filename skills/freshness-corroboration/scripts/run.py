#!/usr/bin/env python3
"""CLI wrapper for the freshness-corroboration specialist skill."""
...
if __name__ == "__main__":
    ...
    try:
        ...
        findings = run_freshness_corroboration(evidence=evidence, website=website)
        print(json.dumps(
            {"ok": True, "skill": "freshness-corroboration", "findings": [f.model_dump() for f in findings]},
