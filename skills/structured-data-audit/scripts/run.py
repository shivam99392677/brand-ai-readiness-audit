#!/usr/bin/env python3
"""CLI wrapper for the structured-data-audit specialist skill."""
...
if __name__ == "__main__":
    ...
    try:
        ...
        findings = run_structured_data_audit(evidence=evidence, website=website)
        print(json.dumps(
            {"ok": True, "skill": "structured-data-audit", "findings": [f.model_dump() for f in findings]},
