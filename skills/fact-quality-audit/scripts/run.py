#!/usr/bin/env python3
"""CLI wrapper for the fact-quality-audit specialist skill."""
...
if __name__ == "__main__":
    ...
    try:
        ...
        findings = run_fact_quality_audit(evidence=evidence, website=website)
        print(json.dumps(
            {"ok": True, "skill": "fact-quality-audit", "findings": [f.model_dump() for f in findings]},
